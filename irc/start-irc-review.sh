...
echo " Channels : #code-review (live PR reviews & debates)"
echo "            #refineid    (general agent discussion)"
...
echo "   weechat -r '/server add local 127.0.0.1/6667; /connect local; /join #code-review'"
